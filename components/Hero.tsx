      ...
      <div className="flex flex-col border-t-2 border-ink md:border-t-0">
        ...
        <div className="flex-1">
          {sidebar.map((s) => {
            ...
            return (
            <Link key={sSlug || s.title} href={sSlug ? `/stories/${sSlug}` : '/news'} className="block px-4 py-[13px] border-b border-ink/15 last:border-b-0 hover:bg-card group no-underline">
