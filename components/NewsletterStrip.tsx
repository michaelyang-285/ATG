    ...
    <div className="bg-ink border-b-2 border-ink w-full">
      <div className="max-w-[860px] mx-auto px-6 py-6 flex items-center gap-10">
        ...
        <div className="flex flex-col items-center gap-2 flex-shrink-0 w-[240px]">
          ...
          <span className="bg-yellow text-ink font-inter text-[11px] font-bold uppercase tracking-[0.8px] px-7 h-10 leading-10 text-center cursor-pointer whitespace-nowrap w-full text-center">
            I'm in →
          </span>
        </div>
      </div>
