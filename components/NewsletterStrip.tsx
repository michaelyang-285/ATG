...
export default function NewsletterStrip({
  ...
  return (
    <div className="bg-ink border-b-2 border-ink w-full">
      <div className="max-w-[1200px] mx-auto px-6 py-[22px] flex items-center justify-between gap-7">
        <div>
        ...
        <div className="flex flex-col items-center gap-2 flex-shrink-0 w-[240px]">
          <input type="email" placeholder="your@email.com"
            className="w-[240px] h-10 px-[14px] bg-[#1c1c1c] border-2 border-[#444] text-white font-inter text-[13px] outline-none focus:border-yellow transition-colors placeholder:text-[#555]" />
          <span className="bg-yellow text-ink font-inter text-[11px] font-bold uppercase tracking-[0.8px] px-7 h-10 leading-10 text-center cursor-pointer whitespace-nowrap">
            I'm in →
          </span>
        </div>
      </div>
