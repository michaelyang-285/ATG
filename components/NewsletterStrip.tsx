...
export default function NewsletterStrip({
  ...
  return (
    <div className="bg-ink border-b-2 border-ink w-full">
      <div className="max-w-[1200px] mx-auto px-6 py-6 flex flex-col md:flex-row md:items-center gap-6 md:gap-10">
        ...
        <div className="flex flex-col items-center gap-2 w-full md:flex-shrink-0 md:w-[320px]">
